                    ...
                    if (user != null)
                    {
                       ...
                       // ddlpartyname.Items.Insert(0, "Select");
                        ...
                        if (Session["rtype"].ToString() != "0")
                        {
                            ...
                            if (Session["CHYfinancial_year"]!=null)
                            {
                                txtcurrentfinancial.Text = Session["CHYfinancial_year"].ToString();
                            }
        ...
        protected void btnSaveasDraft_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                foreach (DataRow dr in table.Rows)
                {
                    ...
                    val = BL_Party_Master.changefinancialyear(name,party_code,userid ,financialendate,startdates,txtcurrentfinancial.Text);
                    //done.InnerText = val;
