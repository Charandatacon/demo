    ...
    public partial class RawMaterialtoFermenterForm : System.Web.UI.Page
    {
        ...
        protected void ddlMolassesStorageVAT_Click(object sender, EventArgs e)
        {
            ...
            if (ddlMolassesStorageVAT.SelectedValue != null)
            {
                ...
                Form82 vats1 = new Form82();
                vats1 = BL_Form82.Getopeningbalancevale(vatcode1, Session["financial_year"].ToString());

                txtAvailableStock.Value = Convert.ToString(vats.vat_availablecapacity + vats1.vat_availablecapacity);
