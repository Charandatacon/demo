    ...
    public partial class Cmsreports : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.UrlReferrer != null)
                {
                    ...
                    ddlsection.DataSource = offence_sections;
                    ddlsection.DataTextField = "Offence_section_name";
                    ddlsection.DataValueField = "offence_section_code";
                    ddlsection.DataBind();
                   ...
                   ddlCourt.DataSource = list4.ToList();
                    ...
                    if (user.user_id == "Admin" || user.role_name.Trim() == "Commissioner" || user.role_name.Trim() == "Deputy Commissioner" || user.role_name.Trim() == "Assistant Commissioner")
                    {
                        var list = (from s in reports
                                    where s.partytype == "Excise" && (s.id != 85 && s.id != 86 && s.id != 87 && s.id != 88 && s.id !=94)
                                    select s);
        ...
        protected void ddlReportName_SelectedIndexChanged(object sender, EventArgs e)
        {
          ...
          DST.Visible = true;
            ...
            if (ddlReportName.SelectedValue == "89" || ddlReportName.SelectedValue == "90")
            {
                DEPT.Visible = false;
                Court.Visible = false;
                DST.Visible = false;
            ...
            if (ddlReportName.SelectedValue == "91" || ddlReportName.SelectedValue == "92" || ddlReportName.SelectedValue == "93")
            {
                DEPT.Visible = false;
                Court.Visible = false;
                DST.Visible = true;
            ...
            if (ddlReportName.SelectedValue == "94" )
            {
                DEPT.Visible = false;
                Court.Visible = false;
                DST.Visible = false;
            ...
            if (ddlReportName.SelectedValue == "96")
            {
                DEPT.Visible = true;
                Court.Visible = false;
                DST.Visible = false;
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            if (ddlReportName.SelectedValue != "Select")
            {
                ...
                Session["section_code"] = ddlsection.SelectedValue;
                if (ddlReportName.SelectedValue.Trim() != "90" && ddlReportName.SelectedValue.Trim() != "89" && ddlReportName.SelectedValue.Trim()!= "77" && ddlReportName.SelectedValue.Trim() != "79"&& ddlReportName.SelectedValue != "75" && ddlReportName.SelectedValue != "60" && ddlReportName.SelectedValue != "68" && ddlReportName.SelectedValue != "71" && ddlReportName.SelectedValue != "81")
                {
                    Session["FromDate"] = Convert.ToDateTime(txtfrom.Value).ToString("yyyy-MM-dd");
                    if (ddlReportName.SelectedValue.Trim() != "93"&&ddlReportName.SelectedValue.Trim() != "91" && ddlReportName.SelectedValue.Trim() != "92")
                    {
