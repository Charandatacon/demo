...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" runat="server">
   ...
   <script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/jquery-ui.min.js"></script> 
    ...
    <script>
        $(function () {
            $("#<%= txtLetterDate.ClientID %>").datepicker({ dateFormat: 'dd-mm-yy' });

            $("#<%= txtDateOfInstitutionOfFIR.ClientID %>").datepicker({ dateFormat: 'dd-mm-yy' });

            $("#<%= txtExciseDateOfInstitutionOfFIR.ClientID %>").datepicker({ dateFormat: 'dd-mm-yy' });

             $("#<%= txtDenaturedDate.ClientID %>").datepicker({ dateFormat: 'dd-mm-yy' });
