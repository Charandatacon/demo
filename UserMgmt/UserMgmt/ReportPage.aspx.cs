    ...
    public partial class ReportPage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                //|| Session["ReportId"].ToString() == "ethanol_stock_register_report"
                else if (Session["ReportId"].ToString() == "rm_stock_ena" || Session["ReportId"].ToString() == "molasses_stock_sugarmill_register" || Session["ReportId"].ToString() == "absolute_alcohol_stock_register"  || Session["ReportId"].ToString() == "ena_stock_register" || Session["ReportId"].ToString() == "impure_spirit_stock_register" || Session["ReportId"].ToString().Trim() == "ena_ethanol_stock_register" || Session["ReportId"].ToString().Trim() == "sds_stock_register" || Session["ReportId"].ToString().Trim() == "grain_stock_register")
                {
                    ReportViewer1.ServerReport.ReportPath = "/" + Session["ReportProject1"].ToString()+"/"+Session["ReportId"].ToString();
                ...
                else if (Session["ReportId"].ToString() == "ethanol_stock_register_report")
                {
                    ReportViewer1.ServerReport.ReportPath = "/" + Session["ReportProject1"].ToString() + "/" + Session["ReportId"].ToString();
                    ...
                    Param[7] = new ReportParameter("Parameter8", Session["vat_code"].ToString());
                    Param[8] = new ReportParameter("Parameter9", Session["Reportfinancialyear"].ToString());
                    Param[9] = new ReportParameter("Parameter10", Session["Fromdate"].ToString());
                    Param[10] = new ReportParameter("Parameter11", Session["ToDate"].ToString());
                ...
                else if (Session["ReportId"].ToString().Trim() == "SectionWiseAccuReport")
                {
                    ReportViewer1.ServerReport.ReportPath = "/" + Session["ReportProject1"].ToString() + "/" + Session["ReportId"].ToString();
                    ReportParameter[] Param = new Microsoft.Reporting.WebForms.ReportParameter[4];
                    Param[0] = new ReportParameter("Parameter1", Session["RaidBy"].ToString());
                    Param[1] = new ReportParameter("Parameter2", Session["section_code"].ToString());
                    Param[2] = new ReportParameter("Parameter3", Session["FromDate"].ToString());
                    Param[3] = new ReportParameter("Parameter4", Session["ToDate"].ToString());
