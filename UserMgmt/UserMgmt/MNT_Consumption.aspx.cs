       ...
       int Doc_id = 1;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "script", "alert(' Add Issue VAT');", true);
                    ddlVAT1.ClearSelection();
                   ddlVAT1.Focus();
                }
                else
                {
                    ...
                    {
                        txtIssueDate.Text = txtdob.Value;
                    }
                    ...
                    {
                        allotment.qty_allotted_till_date += Convert.ToDouble(dt.Rows[j]["consumption_qty"].ToString());
                        allotment.reqd_qty += Convert.ToDouble(dt.Rows[j]["consumption_qtyLPL"].ToString());
                    }
