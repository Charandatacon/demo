                                                    ...
                                                    <table style="padding: 15px">
                                                        <tr>
                                                            ...
                                                            <td><asp:textbox runat="server" id="txtForm" /></td>
                                                             <td><b>FIR No. : </b></td>
                                                            <td><asp:textbox runat="server" id="txtFIR" /></td>
                                                            <td><b>Status : </b></td>
                                                            <td>
                                                    ...
                                                    <asp:GridView ID="grdLabInchargeLogin" runat="server" AutoGenerateColumns="false" PageSize="50" AllowPaging="true"
                                                        ...
                                                        <asp:TemplateField HeaderText="Form No" ItemStyle-Font-Bold="true" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                             ...
                                                             <asp:TemplateField HeaderText="FIR No" ItemStyle-Font-Bold="true" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblFIR" runat="server" Visible="true" Text='<%# Eval("fir_no") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                       <asp:TemplateField HeaderText="Total Sample" ItemStyle-Font-Bold="true" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center">
                                                        ...
                                                        <asp:TemplateField HeaderText="Tested" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="true" ItemStyle-Width="100px">
                                                            ...
                                                            <ItemTemplate>
                                                               ...
                                                               <asp:TemplateField HeaderText="Email" HeaderStyle-HorizontalAlign="Center" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="100px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblemail" runat="server" Visible="false" Text='<%# Eval("email") %>'></asp:Label>
                                                     
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="MobileNo" HeaderStyle-HorizontalAlign="Center" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="225px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblmobile" runat="server" Visible="false" Text='<%# Eval("mobileno") %>'></asp:Label>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action" ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="100px">
                                                         <ItemTemplate>
                                                             <asp:LinkButton Text="View" ID="btnViewCol" CssClass="myButton1" runat="server"
                                                                 ...
                                                                 CommandName="View"><i class="fa fa-search-plus">
                                                                                    </i> 
                                                             </asp:LinkButton> 
                                                         </ItemTemplate> 
                                                      </asp:TemplateField>
                                                      <asp:TemplateField HeaderText="Notified/Download" ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                                                         <ItemTemplate>
                                                               <asp:LinkButton Text="Email" ID="btnEmailCol" CssClass="myButton1" runat="server"                                                                 
                                                                 CommandName="Email"><i class="fa fa-envelope" aria-hidden="true"></i>
                                                             </asp:LinkButton>
                                                             &nbsp;
                                                               <asp:LinkButton Text="SMS" ID="btnSMSCol" CssClass="myButton1" runat="server"                                                                  
                                                                 CommandName="SMS"><i class="fa fa-paper-plane" aria-hidden="true"></i>
                                                             </asp:LinkButton>
                                                             &nbsp;
                                                               <asp:LinkButton Text="Download" ID="btnDownloadCol" CssClass="myButton1" runat="server"                                                                 
                                                                 CommandName="Download"><i class="fa fa-download" aria-hidden="true"></i>
                                                             </asp:LinkButton>
                                                         </ItemTemplate> 
                                                      </asp:TemplateField>
                                                     </columns>
