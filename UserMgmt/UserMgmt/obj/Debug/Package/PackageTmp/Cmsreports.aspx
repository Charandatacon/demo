<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Cmsreports.aspx.cs" Inherits="UserMgmt.Cmsreports" %>
                                ...
                                <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                      ...
                                      <%--  if (document.getElementById('<%=ddlparty.ClientID%>').value == 'Select') {
                                        ...
                                        if (document.getElementById('<%=ddlReportName.ClientID%>').value != '84' && document.getElementById('<%=ddlReportName.ClientID%>').value != '86' && document.getElementById('<%=ddlReportName.ClientID%>').value != '87'&& document.getElementById('<%=ddlReportName.ClientID%>').value != '88' && document.getElementById('<%=ddlReportName.ClientID%>').value != '89' && document.getElementById('<%=ddlReportName.ClientID%>').value != '90'  && document.getElementById('<%=ddlReportName.ClientID%>').value != '91' && document.getElementById('<%=ddlReportName.ClientID%>').value != '92' && document.getElementById('<%=ddlReportName.ClientID%>').value != '93' && document.getElementById('<%=ddlReportName.ClientID%>').value != '94') {
                                        ...
                                        if (document.getElementById('<%=ddlReportName.ClientID%>').value == '96' ) {
                                        ...
                                        debugger
                                              if (document.getElementById('<%=ddlReportName.ClientID%>').value != '75' && document.getElementById('<%=ddlReportName.ClientID%>').value != '77' && document.getElementById('<%=ddlReportName.ClientID%>').value != '79' && document.getElementById('<%=ddlReportName.ClientID%>').value != '81' && document.getElementById('<%=ddlReportName.ClientID%>').value != '89' && document.getElementById('<%=ddlReportName.ClientID%>').value != '90') {
                                                if (document.getElementById('<%=txtFromDATE.ClientID%>').value == '') {
                                                  ...
                                                  if (document.getElementById('<%=ddlReportName.ClientID%>').value == '91' || document.getElementById('<%=ddlReportName.ClientID%>').value == '92' || document.getElementById('<%=ddlReportName.ClientID%>').value == '93') {
                                              ...
                                              <%--  <div id="financialyear"  runat="server" class="col-md-2 col-sm-12 col-xs-12 form-inline">
                                                   ...
                                                   --%>
                                                    <div   id="Court" runat="server" class="col-md-2 col-sm-12 col-xs-12 form-inline">
                                                     ...
                                                     <div   id="Section" runat="server" class="col-md-2 col-sm-12 col-xs-12 form-inline">
                                                        <label class="control-label" style="font-size: small"><span style="color: red">*</span>Section Name</label><br />
                                                        <asp:DropDownList ID="ddlsection" Height="30px" width="95%" runat="server" data-toggle="tooltip" data-placement="right" title="Section Name" name="ddlsection"  CssClass="form-control" Style="">
                                                            <asp:ListItem Enabled="true" Text="--Select--" Value="Select"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
