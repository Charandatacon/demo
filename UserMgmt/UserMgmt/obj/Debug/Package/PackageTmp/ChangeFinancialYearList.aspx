<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ChangeFinancialYearList.aspx.cs" Inherits="UserMgmt.ChangeFinancialYearList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Change Financial Year List</title>
                                  <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdpartymasterList_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdpartymasterList_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "PartyMasterList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_grdpartymasterList_ddlsearch1').change(function () {
                                            $('#BodyContent_grdpartymasterList_txtSearch2').val('');
                                        });
                                    });
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    ...
                                                    <h2>Change Financial Year List</h2>
                                                    <div runat="server" visible="false"   style="float:right">
                                                         <asp:TextBox ID="txtSearch" runat="server" Width="250px" AutoComplete="off"   Height="30px" placeholder="Search Party  Name"  AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" ></asp:TextBox>
                                                    ...
                                                    <ContentTemplate>
                                                <div class="x_content">
                                                    <asp:GridView ID="grdpartymasterList" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" OnPageIndexChanging="grdpartymasterList_PageIndexChanging" EmptyDataText="No Records"
                                                        HeaderStyle-BackColor="#26b8b8" OnDataBound="grdpartymasterList_DataBound" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table">
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                         ...
                                                         <Columns>
                                                              ...
                                                              <asp:TemplateField HeaderText="Financial Year" ItemStyle-Font-Bold="true" ItemStyle-Width="20px"> 
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblfinancial" runat="server" Visible="true" Text='<%#Eval("financialyear") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Party Type Name" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px"> 
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Party  Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px"> 
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblparty_Name" runat="server" Visible="true" Text='<%#Eval("party_Name") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                              <asp:TemplateField HeaderText="Closing Financial Year Date" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">  
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblupdateddate" runat="server" Visible="true" Text='<%#Eval("enddate") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Status"  ItemStyle-Font-Bold="true" ItemStyle-Width="20px">   
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblStatus" runat="server" Visible="true" Text='<%#Eval("party_active") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblApprovalstatus" runat="server" Text='<%# Eval("record_status").ToString() == "A" ? "Approved By Bond Officer" :Eval("record_status").ToString()=="R"? "Rejected":(Eval("record_status").ToString()=="Y"?"Pending":Eval("record_status").ToString()=="D"? "Approved By Deputy Commissioner" : Eval("record_status").ToString()=="C"? "Approved By Commissioner": "Draft") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Center" Font-Underline="False"></HeaderStyle>
                                                <ItemStyle Font-Bold="True" Width="40px"></ItemStyle>
                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Party Type Code" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px"> 
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action" ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:LinkButton Text="Edit" ID="btnEdit"  Visible='<%# Eval("record_status").ToString() == "Y" ? true :false %>' CssClass="myButton1" runat="server" OnClick="btnEdit_Click" CommandName="Edit"><i class="fa fa-pencil-square-o"> 
                                                                                    </i> 
                                                                    </asp:LinkButton>
                                                                </ItemTemplate>
