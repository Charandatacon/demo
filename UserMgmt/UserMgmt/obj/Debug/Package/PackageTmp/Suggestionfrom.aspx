...
<body>
    ...
    <div class="container" style="width: 50%; margin-left: 25%; margin-top: 15%; margin-bottom: 15%; margin-right: 25%">
        <form runat="server">
            <h3 style="margin-left: 35%;margin-bottom:5%" class="control-label">Suggestion Form</h3>

           <%-- <div class="form-row" style="height: 0.1%; background-color: #26b8b8;">
            </div>--%>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-5">
                    ...
                    <br />
                    <asp:TextBox ID="txtcomplainantname" runat="server" CssClass="form-control" autocomplete="off"  data-toggle="tooltip" data-placement="right" title="Complainant Name"></asp:TextBox>
                </div>
                <div class="form-group col-md-5">
            ...
            <div class="form-group col-md-12">
                <label class="control-label"><span style="color: red">*</span>Suggestion</label><br />
