               ...
               form84.user_id = Session["UserID"].ToString();
                ...
                else
                {
                    for (int j = 0; j < grdReceiverVat.Rows.Count; j++)
                    {
                        ...
                        if (System.Math.Round(total, 2) == Convert.ToDouble(txtreceived.Text)  )
                        {
                            ...
                            form84.total_bl_receipt = System.Math.Round(total, 2);
                            form84.total_lp_receipt = System.Math.Round(total1,2);
                        ...
                        else
                        {
                            ...
                            setup.bl_receipt = System.Math.Round(qty.total_bl_receipt,2);
                            setup.lp_receipt = System.Math.Round(qty.total_lp_receipt,2);
                ...
                else
                {
                    for (int j = 0; j < grdReceiverVat.Rows.Count; j++)
                    {
                        ...
                        if (System.Math.Round(total,2) == Convert.ToDouble(txtreceived.Text))
                        {
                            setup.bl_receipt = Convert.ToDouble((grdReceiverVat.Rows[j].FindControl("lblBulkLiters") as Label).Text);
                            setup.lp_receipt = Convert.ToDouble((grdReceiverVat.Rows[j].FindControl("lblLPLiters") as Label).Text);
                            ferm.total_bl_receipt = System.Math.Round(total,2);
                            ferm.total_lp_receipt = System.Math.Round(total1,2);
