   ...
   public class DL_PassDispatch
    {
        ...
        public static string Insert(Pass_Details pass)
        {
            ...
            using (NpgsqlConnection cn = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["CASEMGMT"].ToString()))
            {
                ...
                try
                {
                    ...
                    if (pass.pass_type == "E" || pass.pass_type == "EXP")
                    {
                        pass.pass_type = "EXP";
                        ...
                        str.Append("taxinvoice, remarks,carrier, vehicle_no, vehicle_type, driver, challan_no, digital_lock_no, dispatch_date, dispatch_time, dispatch_duration, route_details, creation_date,  user_id, record_status,party_code,attribute2,deposit_amt,financial_year)values(");
                        ...
                        str.Append("'" + pass.taxinvoice + "','" + pass.remarks + "','" + pass.carrier + "','" + pass.vehicle_no + "','" + pass.vehicle_type + "','" + pass.driver + "','" + pass.challan_no + "','" + pass.digital_lock_no + "','" + pass.dispatch_date + "','" + pass.dispatch_time + "','" + pass.dispatch_duration + "','" + pass.route_details + "','" + DateTime.Now.ToString("dd-MM-yyyy") + "','" + pass.user_id + "','" + pass.record_status + "','" + pass.party_code + "','" + pass.deposit_under + "','" + pass.deposit_amt + "','"+pass.financial_year+"')");
                    }
                    else
                    {
                        pass.pass_type = "DOM";
                        str = new StringBuilder();
                        str.Append("INSERT INTO exciseautomation.pass(pass_id, pass_reqno,request_for_pass_id, pass_date,pass_for, pass_type, rrnoc_record_request_id,");
                        str.Append(" validupto, dispatch_type_id, dispatch_qty,  to_dispatch_vat,supplier_unit,");
                        str.Append("taxinvoice, remarks,carrier, vehicle_no, vehicle_type, driver, challan_no, digital_lock_no, dispatch_date, dispatch_time, dispatch_duration, route_details, creation_date,  user_id, record_status,party_code,attribute2,deposit_amt,financial_year)values(");
                        str.Append("'" + m + "','" + m1 + "','" + pass.request_for_pass_id + "','" + DateTime.Now.ToString("dd-MM-yyyy") + "','" + pass.pass_for + "','" + pass.pass_type + "','" + pass.rrnoc_record_request_id + "',");
                        str.Append("'" + pass.allotment_validupto + "','" + pass.dispatch_type_id + "','" + pass.dispatch_qty + "','" + pass.to_dispatch_vat + "','" + pass.supplier_unit + "',");
                        str.Append("'" + pass.taxinvoice + "','" + pass.remarks + "','" + pass.carrier + "','" + pass.vehicle_no + "','" + pass.vehicle_type + "','" + pass.driver + "','" + pass.challan_no + "','" + pass.digital_lock_no + "','" + pass.dispatch_date + "','" + pass.dispatch_time + "','" + pass.dispatch_duration + "','" + pass.route_details + "','" + DateTime.Now.ToString("dd-MM-yyyy") + "','" + pass.user_id + "','" + pass.record_status + "','" + pass.party_code + "','"+pass.deposit_under+"','"+pass.deposit_amt+"','"+pass.financial_year+"')");
                   }
        ...
        public static Pass_Details GetPassDetails(string passno)
        {
            ...
            using (NpgsqlConnection cn = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["CASEMGMT"].ToString()))
            {
                ...
                try
                {
                    ...
                    using (NpgsqlCommand cmd = new NpgsqlCommand("Select a.*,b.party_name,c.cust_name,d.dispatch_type_name from exciseautomation.pass a left join exciseautomation.party_master b on a.party_code=b.party_code left join exciseautomation.customer_master c on a.customer_id=c.customer_id inner join exciseautomation.dispatch_type_master d on a.dispatch_type_id=d.dispatch_type_id  where a.pass_id='" + passno + "'", cn))
                    {
        ...
        public static string GetAvailableQTY(string vat,string financial_year)
        {
            ...
            using (NpgsqlConnection cn = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["CASEMGMT"].ToString()))
            {
                ...
                try
                {
                    ...
                    dr.Close();
                    str = new StringBuilder();
                    str.Append("Select case when sum(dispatch_qty) is null then 0 else sum(dispatch_qty) end as dispatch_qty  from exciseautomation.pass where record_active='true' and to_dispatch_vat='" + vat + "' and financial_year='" + financial_year + "'and (record_status='I' or record_status='P' or record_status='Y')");
            ...
            using (NpgsqlConnection cn = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["CASEMGMT"].ToString()))
            {
                ...
                try
                {
                    if (pass.record_status == "I")
                    {
                        ...
                        int m1 = Convert.ToInt32(cmd1.ExecuteScalar()) + 1;
                        StringBuilder str = new StringBuilder();
                        str.Append("update exciseautomation.pass set pass_issueno='" + m1 + "',pass_issuedate='" + DateTime.Now.ToString("dd-MM-yyyy") + "',carrier='" + pass.carrier + "',vehicle_no='" + pass.vehicle_no + "',vehicle_type='" + pass.vehicle_type + "',driver='" + pass.driver + "',challan_no='" + pass.challan_no + "',digital_lock_no='" + pass.digital_lock_no + "',dispatch_date='" + pass.dispatch_date + "',dispatch_time='" + pass.dispatch_time + "',dispatch_duration='" + pass.dispatch_duration + "',route_details='" + pass.route_details + "',  record_status='" + pass.record_status + "',rem_pass_qty='" + pass.dispatch_qty + "' where pass_id='" + pass.pass_id + "' and financial_year='" + pass.financial_year + "' and pass_issueno is null ");
                        NpgsqlCommand cmd = new NpgsqlCommand(str.ToString(), cn);
                        cmd.ExecuteNonQuery();
                        if (pass.pass_type == "RR" || pass.pass_type == "M")
                        {
                            cmd = new NpgsqlCommand("select case when rr_lifted_qty is null then 0 else rr_lifted_qty end as rr_lifted_qty from exciseautomation.release_request  WHERE release_request_id='" + pass.rrnoc_record_request_id + "' and financial_year='" + pass.financial_year + "'", cn);
                            double lifted = Convert.ToDouble(cmd.ExecuteScalar());
                            lifted = lifted + pass.dispatch_qty;
                            cmd = new NpgsqlCommand("UPDATE exciseautomation.release_request SET  rr_lifted_qty='" + lifted + "' WHERE release_request_id='" + pass.rrnoc_record_request_id + "' and financial_year='" + pass.financial_year + "'", cn);
                            cmd.ExecuteNonQuery();
                            str = new StringBuilder();
                        ...
                        else
                        {
                            ...
                            if (pass.pass_type == "DOM" || pass.pass_type == "N")
                            {
                                cmd = new NpgsqlCommand("Select count(1) from exciseautomation.rawmaterial_receipt where passno='" + pass.pass_reqno + "' and financial_year='" + pass.financial_year + "'", cn);
                                string cnt = cmd.ExecuteScalar().ToString();
                                if (cnt == "" || cnt == "0")
                                {
                                    cmd = new NpgsqlCommand("Select Max(rawmaterial_receipt_id) from exciseautomation.rawmaterial_receipt where financial_year='" + pass.financial_year + "' ", cn);
                                    ...
                                    str1.Append("'" + rmrid + "','" + pass.party_code + "','" + pass.to_party_code + "','" +pass.pass_id + "','" + DateTime.Now.ToString("dd-MM-yyyy") + "','" + pass.dispatch_qty + "','" + pass.vehicle_no + "','" + pass.dispatch_qty + "','"+pass.financial_year+"')");
                                    ...
                                    str2.Append("'" + rmrid + "','" + DateTime.Now.ToString("dd-MM-yyyy") + "','MIR','" + rmrid + "','" + pass.party_code + "','" + pass.to_dispatch_vat + "','" + pass.dispatch_qty + "','" + pass.user_id + "','" + DateTime.Now.ToString("dd-MM-yyyy") + "','"+pass.financial_year+"')");
                                    cmd = new NpgsqlCommand(str2.ToString(), cn);
                                    cmd.ExecuteNonQuery();
                                }
                            
                            //cmd = new NpgsqlCommand("select case when liftedqty is null then 0 else liftedqty end as liftedqty from exciseautomation.noc_depotdetail  WHERE noc_id='" + pass.rrnoc_record_request_id + "' and noc_depotdetail_id=", cn);
                            //double lifted = Convert.ToDouble(cmd.ExecuteScalar());
                            //lifted = lifted + pass.dispatch_qty;
                            //cmd = new NpgsqlCommand("UPDATE exciseautomation.noc_depotdetail SET  liftedqty='" + lifted + "' WHERE noc_id='" + pass.rrnoc_record_request_id + "'", cn);
        ...
        public static string Update(Pass_Details pass)
        {
            ...
            using (NpgsqlConnection cn = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["CASEMGMT"].ToString()))
            {
                ...
                {
                    StringBuilder str = new StringBuilder();
                    if (pass.pass_type == "EXP")
                    {
                        str.Append("update exciseautomation.pass set  dispatch_type_id='" + pass.dispatch_type_id + "', dispatch_qty='" + pass.dispatch_qty + "',  to_dispatch_vat='" + pass.to_dispatch_vat + "',noc_depotdetail_id='" + pass.noc_depotdetail_id + "', taxinvoice='" +pass.taxinvoice+"', remarks='" + pass.remarks + "',carrier='" + pass.carrier + "',vehicle_no='" + pass.vehicle_no + "',vehicle_type='" + pass.vehicle_type + "',driver='" + pass.driver + "',challan_no='" + pass.challan_no + "',digital_lock_no='" + pass.digital_lock_no + "',dispatch_date='" + pass.dispatch_date + "',dispatch_time='" + pass.dispatch_time + "',dispatch_duration='" + pass.dispatch_duration + "',route_details='" + pass.route_details + "',record_status='" + pass.record_status + "',lastmodified_date='" + DateTime.Now.ToString("dd-MM-yyyy") + "',user_id='" + pass.user_id + "',attribute2='"+pass.deposit_under+ "',deposit_amt='"+pass.deposit_amt+"' where pass_id='" + pass.pass_id + "' and financial_year='" + pass.financial_year + "'");
                    }
                    else if ( pass.pass_type == "DOM")
                    {
                        str.Append("update exciseautomation.pass set  dispatch_type_id='" + pass.dispatch_type_id + "', dispatch_qty='" + pass.dispatch_qty + "',  to_dispatch_vat='" + pass.to_dispatch_vat + "', taxinvoice='" + pass.taxinvoice + "', remarks='" + pass.remarks + "',carrier='" + pass.carrier + "',vehicle_no='" + pass.vehicle_no + "',vehicle_type='" + pass.vehicle_type + "',driver='" + pass.driver + "',challan_no='" + pass.challan_no + "',digital_lock_no='" + pass.digital_lock_no + "',dispatch_date='" + pass.dispatch_date + "',dispatch_time='" + pass.dispatch_time + "',dispatch_duration='" + pass.dispatch_duration + "',route_details='" + pass.route_details + "',record_status='" + pass.record_status + "',lastmodified_date='" + DateTime.Now.ToString("dd-MM-yyyy") + "',user_id='" + pass.user_id + "',attribute2='" + pass.deposit_under + "',deposit_amt='" + pass.deposit_amt + "' where pass_id='" + pass.pass_id + "' and financial_year='" + pass.financial_year + "'");
                    }
                    else
                    ...
                    //else
                    //{
                    //    str.Append("update exciseautomation.pass set dispatch_type_id='" + pass.dispatch_type_id + "', dispatch_qty='" + pass.dispatch_qty + "',to_dispatch_vat='" + pass.to_dispatch_vat + "',prev_prod_year='" + pass.prev_prod_year + "', brix='" + pass.brix + "', sugar_content='" + pass.sugar_content + "', taxinvoice='" + pass.taxinvoice + "', remarks='" + pass.remarks + "',record_status='" + pass.record_status + "',lastmodified_date='" + DateTime.Now.ToString("dd-MM-yyyy") + "',user_id='" + pass.user_id + "' where pass_id='" + pass.pass_id + "'");
                    //}
                    if (pass.pass_type == "E" )
                    {
                        pass.pass_type = "EXP";
        ...
        public static List<Pass_Details> GetPassList()
        {
            ...
            using (NpgsqlConnection cn = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["CASEMGMT"].ToString()))
            {
                ...
                try
                {
                    using (NpgsqlCommand cmd = new NpgsqlCommand("Select distinct(a.financial_year),a.*,b.party_name,c.cust_name,d.pass,d.noc,case when a.pass_type like 'NOC' then f.issue_nocno else f.issue_nocno end as RR_NOC_IssuedNo,d1.permit as release_request1,g.permit_issueno  from exciseautomation.pass a left join exciseautomation.permit g on a.rrnoc_record_request_id=g.permit_id and a.financial_year=g.financial_year  left join exciseautomation.party_master b on g.party_code=b.party_code left join exciseautomation.customer_master c on a.customer_id=c.customer_id and a.party_code=c.party_code left join exciseautomation.document_format_master d on d.party_code=a.supplier_unit left join exciseautomation.document_format_master d1 on g.party_code=d1.party_code left join exciseautomation.Release_request e on e.release_request_id=a.rrnoc_record_request_id and a.financial_year=e.financial_year left join exciseautomation.NOC f on a.rrnoc_record_request_id=f.noc_id  and a.party_code=f.party_code where a.record_active='true' order by a.dispatch_date,a.pass_issueno", cn))
                    {
                    //    using (NpgsqlCommand cmd = new NpgsqlCommand("Select a.*,b.party_name,c.cust_name,d.pass,d.noc,case when a.pass_type like 'NOC' then f.issue_nocno else f.issue_nocno end as RR_NOC_IssuedNo,d1.release_request as release_request1,g.permit_issueno,r.party_code as party  from exciseautomation.pass a left join exciseautomation.permit g on a.rrnoc_record_request_id=g.permit_id  left join exciseautomation.party_master b on g.party_code=b.party_code left join exciseautomation.customer_master c on a.customer_id=c.customer_id and a.party_code=c.party_code left join exciseautomation.document_format_master d on d.party_code=a.supplier_unit left join exciseautomation.document_format_master d1 on d1.party_code=a.party_code left join exciseautomation.Release_request e on e.release_request_id=a.rrnoc_record_request_id left join exciseautomation.NOC f on a.rrnoc_record_request_id=f.noc_id left join exciseautomation.user_registration h on g.purchase_from_party=h.user_id left join exciseautomation.party_master r on h.party_code=r.party_code  order by a.pass_reqno,a.pass_issueno", cn))
                    //{
                        cmd.CommandType = System.Data.CommandType.Text;
                        //cmd.Parameters.AddWithValue("@UserID", userid);
                        NpgsqlDataReader dr = cmd.ExecuteReader();
                        ...
                        if (dr.HasRows)
                        {
                            ...
                            while (dr.Read())
                            {
                                ...
                                //record.customer_id = dr["customer_id"].ToString();
                                if (dr["pass_type"].ToString() == "DOM")
                                ...
                                if (dr["pass_type"].ToString() == "DOM")
                                    record.rr_noc_issuedno = dr["release_request1"].ToString() + dr["financial_year"].ToString() + "/" + dr["permit_issueno"].ToString();
                                else
        ...
        public static List<Pass_Details> Search(string tablename, string column, string value)
        {
            ...
            using (NpgsqlConnection cn = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["CASEMGMT"].ToString()))
            {
                ...
                try
                {
                    ...
                    using (NpgsqlCommand cmd = new NpgsqlCommand("Select a.*,b.party_name,c.cust_name,d.pass,d.noc,case when a.pass_type like 'NOC' then f.issue_nocno else f.issue_nocno end as RR_NOC_IssuedNo,d1.permit as release_request1,g.permit_issueno  from exciseautomation.pass a left join exciseautomation.permit g on a.rrnoc_record_request_id=g.permit_id  left join exciseautomation.party_master b on g.party_code=b.party_code left join exciseautomation.customer_master c on a.customer_id=c.customer_id and a.party_code=c.party_code left join exciseautomation.document_format_master d on d.party_code=a.supplier_unit left join exciseautomation.document_format_master d1 on g.party_code=d1.party_code left join exciseautomation.Release_request e on e.release_request_id=a.rrnoc_record_request_id and a.financial_year=e.financial_year left join exciseautomation.NOC f on a.rrnoc_record_request_id=f.noc_id and a.party_code=f.party_code where " + column + " Ilike '%" + value + "%' and a.record_active='true' order by a.pass_reqno,a.pass_issueno", cn))
                    {
                        cmd.CommandType = System.Data.CommandType.Text;
                        //cmd.Parameters.AddWithValue("@UserID", userid);
                        NpgsqlDataReader dr = cmd.ExecuteReader();
        ...
        public static Pass_Details GetDetails(string pass_id,string financial_year)
        {
            ...
            using (NpgsqlConnection cn = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["CASEMGMT"].ToString()))
            {
                ...
                try
                {
                    ...
                    using (NpgsqlCommand cmd = new NpgsqlCommand("Select a.*,d1.pass from exciseautomation.pass a left join exciseautomation.document_format_master d1 on d1.party_code=a.party_code where a.pass_id='" + pass_id + "' and a.financial_year='"+financial_year+"'", cn))
                    {
                        cmd.CommandType = System.Data.CommandType.Text;
                        //cmd.Parameters.AddWithValue("@UserID", userid);
                        NpgsqlDataReader dr = cmd.ExecuteReader();
                        if (dr.HasRows)
                        {
                            ...
                            while (dr.Read())
                            {
                                ...
                                pass.deposit_amt = dr["deposit_amt"].ToString();
                                pass.deposit_under = dr["attribute2"].ToString();
                            }
                        }
                    }
                    cn.Close();
