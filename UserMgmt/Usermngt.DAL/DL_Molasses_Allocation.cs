        ...
        public static string UpdateMNTConsumReg(Molasses_Allocation allotment)
        {
            ...
            using (NpgsqlConnection cn = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["CASEMGMT"].ToString()))
            {
                ...
                try
                {
                    //(,molasses_allotment_request_id
                    StringBuilder str = new StringBuilder();
                    str.Append("Update exciseautomation.consumption_register set record_status='" + allotment.record_status + "',consumption_date='" + allotment.consumption_date + "', product_code='" + allotment.product_code + "', remarks='" + allotment.remarks + "',total_wastage='"+allotment.prov_indent_qty+ "',total_consumption_bl_qty='"+allotment.qty_allotted_till_date+ "',total_consumption_lp_qty='"+allotment.reqd_qty+"', consumption_reqno='" + allotment.application_requestno + "',lastmodified_date='" + DateTime.Now.ToString("dd-MM-yyyy") + "',user_id='" + allotment.user_id + "' WHERE consumption_no='" + allotment.issue_no+"' and financial_year = '"+allotment.financial_year+"'");
